// Catálogo de alimentos — fonte única usada pela página Alimentos, pelo Manual e pelo diário.
export type Categoria = "Frutas" | "Verduras" | "Legumes" | "Tubérculos" | "Grãos" | "Outros";
...
export const TOMATE = "var(--tomato)";
export const FOLHA = "var(--leaf)";
export const SOL = "var(--sun)";
export const BERRY = "var(--berry)";
export const ACCENT = "var(--accent)";

// Fotos reais dos alimentos. Itens com erro anterior usam links públicos verificados.
export const WIKI = (file: string) =>
  `https://commons.wikimedia.org/wiki/Special:FilePath/${encodeURIComponent(file)}?width=800`;

export const IMG_URL: Record<string, string> = {
  // Frutas
  ...
  "Maracujá": "https://images.unsplash.com/photo-1604495772376-9657f0035eb5?auto=format&fit=crop&w=800&q=80",
  ...
  "Rúcula": "https://images.unsplash.com/photo-1622206151226-18ca2c9ab4a1?auto=format&fit=crop&w=800&q=80",
...
export const CATEGORIAS: ("Todos" | Categoria)[] = ["Todos", "Frutas", "Verduras", "Legumes", "Tubérculos", "Grãos", "Outros"];
